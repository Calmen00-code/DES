...
OBJ = main.o conversion.o file.o permutation.o encrypt.o decrypt.o ffunc.o
EXEC = main
...
decrypt.o : decrypt.c header.h encrypt.h file.h permutation.h ffunc.h conversion.h
